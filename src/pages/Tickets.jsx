      ...
      <form className="ticket-form" onSubmit={handleSubmit} noValidate>
        <div className="form-row">
          <label className="ticket-label">
            <span>Title</span>
            <input className="ticket-input" name="title" value={form.title} onChange={handleChange} aria-describedby="err-title" />
            <div className="error" id="err-title">{errors.title}</div>
          </label>

          <label className="ticket-label">
            <span>Status</span>
            <select className="select" name="status" value={form.status} onChange={handleChange} aria-describedby="err-status">
